  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Job Board Website" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="flex flex-col gap-4 justify-center align-middle items-center h-screen">
        <div role="status">
          <svg
            aria-hidden="true"
        ...
        <span className="font-semibold text-lg">Loading Job Board...</span>
      </main>
    </>
  );
}
